...
class BirthdaysCommand(Command):
    ...
    def execute(self):
        ...
        if isinstance(
            upcoming_birthdays, str
        ):  # If there's a message instead of a list
...
class InvokerInterface(ABC):
    ...
    def execute_command(
        self,
        command_map: Dict[EnumCommandsType, Command] = command_map
    ):
        pass
